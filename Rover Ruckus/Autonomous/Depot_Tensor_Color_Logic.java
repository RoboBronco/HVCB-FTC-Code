...
@Autonomous(name="Depot Tensor Color Logic", group="Auto")
public class Depot_Tensor_Color_Logic extends LinearOpMode {
                      ...
                      if (updatedRecognitions.size() >= 2) {
                        ...
                        if (goldMineralX != -1 && silverMineral1X != -1) {
                         ...
                         // move backward at wall
                             robot.backward();
                             runtime.reset();
                             while(opModeIsActive() && (runtime.seconds() <= 1.27)){
                             //telemetry.addData("Detach", "Time: %2.5f S Elapsed", runtime.seconds());
                             }robot.stop();
                             robot.forward();
                             runtime.reset();
                        ...
                        sleep(5000);
                            ...
                            telemetry.update();
                             ...
                             // This is just a place holder, to make our other movements easier to find.
                            // robot.spinRight();
                            // sleep(500);
                            // This is just a place holder, to make our other movements easier to find.
                       ...
                       //////////////LEFT//////////////
                        ...
                        // spin right to to aim at depot wall
                         ...
                         robot.backward();
                         runtime.reset();
                         while(opModeIsActive() && (runtime.seconds() <= 1.79)){
                         //telemetry.addData("Detach", "Time: %2.5f S Elapsed", runtime.seconds());
                         }robot.stop();
                         robot.forward();
                         runtime.reset();
